...
// Use the existing DEMO_PROJECTS constant here...
const DEMO_PROJECTS = [
  { 
    id: 101, 
    ...
    deadline: '2 Weeks',
    phases: [
      { id: 1, name: 'Planning', tasks: [{ id: 1, text: 'Define User Personas', completed: true }, { id: 2, text: 'System Architecture', completed: true }] },
      { id: 2, name: 'Execution', tasks: [{ id: 4, text: 'Auth Setup', completed: true }, { id: 5, text: 'Stripe Integration', completed: false }] },
      { id: 3, name: 'Review', tasks: [] },
      { id: 4, name: 'Launch', tasks: [] }
    ]
  },
  { id: 102, title: 'Q3 Marketing Blitz', type: 'Marketing', status: 'At Risk', currentPhase: 3, nextTask: 'Ad Spend Approval', deadline: 'Overdue', phases: [] }
];

export default function Dashboard() {
  const [projects, setProjects] = useState([]);
  const [logoLoaded, setLogoLoaded] = useState(false); // New state to handle overlap
        ...
        <div className="p-6 border-b border-white/5 flex items-center gap-3">
          ...
          <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-blue-600 flex items-center justify-center text-white font-bold shrink-0">
             <Image 
               ...
               onLoad={() => setLogoLoaded(true)} // Hide 'P' when loaded
